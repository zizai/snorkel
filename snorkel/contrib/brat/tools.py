...
from ...parsers import TextDocPreprocessor, CorpusParser
...
class Brat(object):
    ...
    def __init__(self, session=None, tmpl_path='tmpl.config', encoding="utf-8", verbose=True):
        """
    ...
    def import_project(self, input_dir, annotations_only=True, create_candidates=True,
                       annotator_name='brat', num_threads=1, parser=None):
        """
        Import BART project,
        :param input_dir:
        :param autoreload:
